...
<head>
    ...
    <link href="{{ mix('/css/client/vendor.css') }}" type="text/css" rel="stylesheet"/>
...
<header class="header-wrap">
    <nav class="navbar navbar-light">
        <div class="container-fluid">
            <div class="wrap flex-row justify-content-between">
                <a class="navbar-brand" href="#">
                    IQ Vibe
                </a>
                <div class="btn-add">
                    <a href="{{route('client.json')}}" class="btn-add__plus">
...
<footer class="footer mt-auto py-3">
    <div class="container-fluid">
        <span class="">IQ Vibe &copy; 2021</span>
    </div>
</footer>
</body>
</html>
